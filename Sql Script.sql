...
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Mesmerizing Green Eyes',N'Painting',480,N'Oak Lea',N'40x30',N'../Images/Product/product_image1.jpg',N'A beautiful blonde with red tips and hypnotic green eyes',N'../Images/product_thumbnail/product_image1.jpg')
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Black & White',N'Painting',460,N'Oak Lea',N'30x40',N'../Images/Product/product_image2.jpg',N'A black and white pencil and brush sketch',N'../Images/product_thumbnail/product_image2.jpg')
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Miscellaneous in the yard',N'Painting',450,N'Oak Lea',N'30x40',N'../Images/Product/product_image3.jpg',N'Miscellaneous items along with letters and a burned out candle thrown out on the lawn of a yard',N'../Images/product_thumbnail/product_image3.jpg')
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Femme fatale',N'Painting',500,N'Oak Lea',N'30x40',N'../Images/Product/product_image4.jpg',N'A beautiful nude drawing of a young femme fatale',N'../Images/product_thumbnail/product_image4.jpg')
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Newly-wed',N'Painting',33.99,N'Oak Lea',N'50x50',N'../Images/Product/product_image5.jpg',N'Picture of a middle aged bride in her newly furbished house',N'../Images/product_thumbnail/product_image5.jpg')
...
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'Crow Abstract Giclee Print On Canvas', N'Painting', 310, N'Mike Lea', N'30x40', N'../Images/Product/product_image7.jpg', N'Watermarks will not be present on final printed images.',N'../Images/product_thumbnail/product_image7.jpg')
INSERT [dbo].[products] ([name], [type], [price], [artist], [size], [image], [description]) VALUES (N'No. 17 Abstract Giclee Print On Canvas', N'Painting', 85, N'Mike Lea', N'12x12', N'../Images/Product/product_image8.jpg', N'Watermarks will not be present on final printed images.',N'../Images/product_thumbnail/product_image8.jpg')
GO
