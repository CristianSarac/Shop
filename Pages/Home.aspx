...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="clearfix">
        ...
        <h3>Impressing the impressionism current</h3>
        <p>
    ...
    <div class="clearfix">
        ...
        <p>
            This piece of art is easy recognisable given its "flooding" lines, which
            flow to the ends of the Earth, granting dynamism. Embarking on the ideea
            that plastic art and architecture are eminently abstract, our artist manifests,
            with a liberating sensation, his whole emotional burden.
        </p>
    </div>
    <div class="clearfix">
