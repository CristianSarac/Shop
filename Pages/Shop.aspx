                        ...
                        <td>
                            ...
                            <div class="details">
                                <div class="alignLeft">
                                    ...
                                    <asp:Label ID="lblId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "id") %>' Visible="false" /><br />
                                    <asp:Label ID="lblDescription" CssClass="ProductsDescription" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"description") %>' /><br />
                                    <asp:Label ID="lblPrice" runat="server" CssClass="ProductsPrice" Text='<%# String.Format("{0:c}", DataBinder.Eval(Container.DataItem, "price")) %>' Font-Bold="true" /><br />
                                    <div>
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Label ID="lblWish" ForeColor="Red" runat="server" Text="<html>This item has been<br/> added to your wishlist!<html>" Visible="false" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
